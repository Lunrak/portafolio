import { EstadoCarta, DificultadMemoria, calcularPuntuacion, } from "./interfaces.js";
import { barajarArray } from "./utils.js";
export class JuegoMemoria {
    tablero;
    cartaSeleccionadaPrevia = null;
    tiempoInicio = 0;
    tiempoFin = 0;
    constructor(dificultad = DificultadMemoria.Facil) {
    ...
    crearTablero(dificultad) {
        ...
        const emojisSeleccionados = barajarArray([...emojisDisponibles]).slice(0, totalParejas);
        const cartas = [];
        let id = 0;
    ...
    obtenerPuntuacion() {
        const tiempoSegundos = Math.floor((this.tiempoFin - this.tiempoInicio) / 1000);
        return calcularPuntuacion(this.tablero.intentos, tiempoSegundos, this.tablero.dificultad);
    }
}
